...
function cacheFunction(cb) {
  ...
  return function (prop){
    if (guardarResult.hasOwnProperty(prop)) {
      return guardarResult[prop]
    } else {
      return guardarResult[prop]= cb(prop)
    }
  }
};
...
cacheFunction()
  ...
  que, al realizar una operación por segunda vez, se pueda obtener el resultado de esa "memoria" sin tener 
